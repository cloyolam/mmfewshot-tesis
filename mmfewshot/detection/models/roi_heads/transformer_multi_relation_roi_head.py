...
class TransformerMultiRelationRoIHead(StandardRoIHead):
    ...
    def forward_train(self,
        ...
        print(f"  len(support_gt_bboxes) = {len(query_gt_labels)}")
        # print(f"  len(query_gt_bboxes_ignore) = {len(query_gt_bboxes_ignore)}")
        ...
        '''
        print("  preparing contrastive training data done!")
